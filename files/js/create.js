if (localStorage.getItem("auth") != "true" && location.href.includes("/create")) {
    location.href = '/login?=/create';
};

if(localStorage.getItem("auth") == "true") {
    console.log(localStorage.getItem('ACCOUNT_TOKEN'));
    document.getElementById('Account_TOKEN').setAttribute("value", localStorage.getItem('ACCOUNT_TOKEN'));
};
